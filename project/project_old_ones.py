...
# --- 1. Load the Data ---
print("Loading data...")
# We use pandas to read the file first as it's faster than the native networkx reader (just a little bit)
...
plt.xlabel('Node ID')
plt.ylabel('Percentage of Total Network Edges (%) (total edges = {})'.format(total_edges))
